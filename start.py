...
#time.sleep(5)
rard = subprocess.Popen(['sudo', 'python', '/home/pi/main.py', '&'], shell=False)
#time.sleep(5)
lard = subprocess.Popen(['sudo', 'python', '/home/pi/main2.py', '&'], shell=False)
#time.sleep(5)
serv = subprocess.Popen(['sudo', 'python', '/home/pi/servo2.py', '&'], shell=False)
